...
export function ForumIcon(props: PropsType) {
  return (
    <svg
      width="18"
      height="18"
      ...
      {...props}
    >
      <path d="M4 4h13a2 2 0 0 1 2 2v7a2 2 0 0 1-2 2H7l-3 3V6a2 2 0 0 1 2-2zm2 2v8h11V6H6zm13 3h1a2 2 0 0 1 2 2v8l-3-3h-4v-2h4V9z" />
    </svg>
  );
}
...
export function FlashcardIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      width="18"
      height="18"
