...
export const uploadTextbookToCloudinary = async (file: File): Promise<string> => {
  try {
    const formData = new FormData();
...
export const uploadNotesToCloudinary = async (file: File): Promise<string> => {
  try {
    const formData = new FormData();
    formData.append('file', file);
    formData.append('upload_preset', 'meterials_upload');
    formData.append('resource_type', 'raw'); // Explicitly set resource type
    formData.append('folder', 'notes');   // Optional: organize in folders
...
export const uploadTutorPicToCloudinary = async (file: File): Promise<string> => {
  try {
    const formData = new FormData();
    formData.append('file', file);
    formData.append('upload_preset', 'meterials_upload');
    formData.append('resource_type', 'image'); // Explicitly set resource type
    formData.append('folder', 'tutorPicture');   // Optional: organize in folders
    ...
    const data = await response.json();
    console.log('Image upload with options response:', data);
